...
function ManageCourse() {
  ...
  return (
    <div className={`dashboard ${navButtonClick && "dashboard-full"} class`}>
      <Header />
      <button
        type="button"
        className="btn d-flex text-decoration-underline"
        onClick={() => {
      ...
      <div className="d-flex align-items-center gap-3 mb-5 mt-4">
        ...
        <h6 className="mb-0">Manage Course | Add Course</h6>
      </div>
      <form action="">
        <div className="row">
              ...
              <div className="d-flex align-items-start flex-wrap gap-3">
                    ...
                    <div className="d-flex flex-column gap-3">
                      <div className="d-flex align-items-center gap-3">
                        <div className="d-flex align-items-center gap-3">
                          ...
                          <label htmlFor="class">Per Course</label>
                        </div>
                        <div className="d-flex align-items-center gap-3">
                ...
                <div className="d-flex align-items-center gap-3">
                  <input
                    ...
                    onChange={(e) => handlePrice(e)}
                  />
                  <label htmlFor="demo">Demo (Single Course)</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-md-6">
            <div className="input-container mb-3 d-flex flex-column">
              <label htmlFor="">Course Category Type</label>
              <Select
                options={languageOptions}
                isMulti
                value={selectedLanguages}
          ...
          <div className="col-12 col-md-6">
            <div className="input-container mb-3 d-flex flex-column">
              <label htmlFor="">Course Mode</label>
          ...
          {mode == "online" && (
            <>
              <div className="col-12 col-md-6">
                <div className="input-container mb-3 d-flex flex-column">
                  <label htmlFor="">Course Link</label>
                  <input
                    className="py-1 px-2 batch-input"
                    type="url"
              ...
              <div className="col-12 col-md-6">
                <div className="input-container mb-3 d-flex flex-column">
                  <label htmlFor="">Course Link Password</label>
                  <input
                    className="py-1 px-2 batch-input"
                    type="password"
          ...
          <div className="col-12 col-md-6">
            <div className="input-container mb-3 d-flex flex-column">
              <label htmlFor="">Course Days</label>
              <div className="d-flex align-items-center flex-wrap gap-3">
                <div className="d-flex align-items-center gap-3">
                  <input
                    type="radio"
          ...
          <div className="col-12 col-md-6">
            <div className="input-container mb-3 d-flex flex-column">
              <label htmlFor="classImage">Course Image</label>
              <span>
                {imagePreview && (
